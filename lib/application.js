...
class Application extends EventEmitter {
  constructor() {
    ...
    this.orchestration = new Code('orchestration', this, { typescript: true });
    this.integration = new Code('integration', this, { typescript: true });
    this.domain = new Code('domain', this, { typescript: true });
    this.repo = new Code('repo', this, { typescript: true });
    this.usecase = new Code('usecase', this, { typescript: true });
  ...
  createSandbox() {
    ...
    sandbox.orchestration = this.orchestration.tree;
    sandbox.integration = this.integration.tree;
    sandbox.domain = this.domain.tree;
    sandbox.repo = this.repo.tree;
    sandbox.usecase = this.usecase.tree;
